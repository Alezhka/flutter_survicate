...
class FlutterSurvicatePlugin: FlutterPlugin, MethodCallHandler {
    ...
    companion object {
      ...
      fun registerWith(registrar: Registrar) {
        val instance = FlutterSurvicatePlugin()
        instance.context = registrar.context()
        instance.methodChannel = MethodChannel(registrar.messenger(), "survicate")
        instance.methodChannel.setMethodCallHandler(instance)
        instance.eventChannel = EventChannel(registrar.messenger(), "events")
